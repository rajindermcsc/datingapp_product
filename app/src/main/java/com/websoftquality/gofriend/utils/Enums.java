package com.websoftquality.gofriend.utils;
/**
...
public class Enums {
    public static final String MY_PHONE_NUMBER = "com.websoftquality.gofriend.views.signup.PhoneNumberFragment";
    public static final String ONE_TIME_PWD = "com.websoftquality.gofriend.views.signup.OneTimePwdFragment";
    public static final String GENDER = "com.websoftquality.gofriend.views.signup.GenderFragment";
    public static final String FIRST_NAME = "com.websoftquality.gofriend.views.signup.FirstNameFragment";
    public static final String LAST_NAME = "com.websoftquality.gofriend.views.signup.LastNameFragment";
    public static final String PASSWORD = "com.websoftquality.gofriend.views.signup.PasswordFragment";
    public static final String BIRTHDAY = "com.websoftquality.gofriend.views.signup.BirthdayFragment";
    public static final String EMAIL = "com.websoftquality.gofriend.views.signup.EmailFragment";
    public static final String PROFILE_PICK = "com.websoftquality.gofriend.views.signup.ProfilePickFragment";
