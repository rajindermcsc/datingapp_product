...
public class Enums {
    public static final String MY_PHONE_NUMBER = "com.datingapp.views.signup.PhoneNumberFragment";
    public static final String ONE_TIME_PWD = "com.datingapp.views.signup.OneTimePwdFragment";
    public static final String GENDER = "com.datingapp.views.signup.GenderFragment";
    public static final String FIRST_NAME = "com.datingapp.views.signup.FirstNameFragment";
    public static final String LAST_NAME = "com.datingapp.views.signup.LastNameFragment";
    public static final String PASSWORD = "com.datingapp.views.signup.PasswordFragment";
    public static final String BIRTHDAY = "com.datingapp.views.signup.BirthdayFragment";
    public static final String EMAIL = "com.datingapp.views.signup.EmailFragment";
    public static final String PROFILE_PICK = "com.datingapp.views.signup.ProfilePickFragment";
